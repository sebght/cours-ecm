                    ...
                    <div class="col-xs-12">
                        <spring:bind path="ingredients">
                            <div class="form-group ${status.error ? 'has-error' : ''}">
                                ...
                                <button type="button" class="btn btn-default btn-xs" data-role="addSel"><span class="glyphicon glyphicon-plus" aria-hidden="true">Sel</span></button>
                                <button type="button" class="btn btn-default btn-xs" data-role="addPoivre"><span class="glyphicon glyphicon-plus" aria-hidden="true">Poivre</span></button>
                                <div id="ingredients">
